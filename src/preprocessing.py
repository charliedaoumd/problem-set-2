...
print(f"What share of arrestees in the `df_arrests` table were rearrested in the next year??? {share_rearrested_felony:.2%}")
...
print(f"What share of current charges are now felonies??? {share_current_felonies:.2%}")
